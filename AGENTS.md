...
- All AI-generated research documents, analysis APIs, slide scripts → `/Solution/docs/ai/`.
- All action plans, verification criteria (`todo.md`), lessons learned (`lessons.md`) → `/tasks/`.
- The entire application development source code, API tools, UI components → `/Product/`.
- Absolutely no junk code files or test files should be generated outside the `/Product/` directory.
